...
It contains information about the RabbitMQ design, usage and configuration options, as well as information on the Stream Cloud Stream concepts map into RabbitMQ specific constructs.

== Usage

For using the RabbitMQ binder
...
This sections contains settings that are specific to the RabbitMQ binder and its 
